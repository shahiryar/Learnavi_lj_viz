...
const nodes= ["Introduction to ML", "Maths for ML", "ANN", "CNN", "Image Processing with CNN"]
...
export default function App() {
    ...
    return (<>
        <Canvas id="mainCanvas" style={{ backgroundColor: "black", cursor:"move" }}>
            ...
            <CameraControls />
            <SilverSphere position={[-3, 0, 0]} size={0.4} label="Virtual Reality"/>
            <SilverSphere position={[3, 0, 0]} size={0.5} label="Omer"/>
            <SilverSphere position={[-1, -3, 0]} size={0.2} label="Java"/>
            <SilverSphere position={[1, 3, 0]} size={0.6} label="Socket"/>
            <SilverSphere position={[-3, 0, -3]} size={1} label="Networking"/>
            <SilverSphere position={[-2, 1, 2]} size={0.5} label="AR"/>
            <SilverSphere position={[1, -3, -3]} size={1.1} label="Machine Learning"/>
            <SilverSphere position={[0, 3, -5]} size={0.3} label="React Native"/> 
